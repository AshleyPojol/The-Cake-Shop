                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
											...
											$query = "SELECT usertype FROM register WHERE usertype='Admin' ";
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                ...
                                                <div class="col">
													...
													<?php
													require './database/dbconfig.php';
													$query = "SELECT id FROM ingredients ORDER BY id";
													$query_run = mysqli_query($connection, $query);	
													$row = mysqli_num_rows($query_run);
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Number of Employee </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
											
											<?php
											require './database/dbconfig.php';
											$query = "SELECT usertype FROM register WHERE usertype='Employee' ";
											$query_run = mysqli_query($connection, $query);	
											$row = mysqli_num_rows($query_run);
											echo '<h5> Total Employee: ' .$row. '</h5>';
											?>
											<h1></h1>
											</div>
                                        </div>
